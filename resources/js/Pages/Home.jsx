    ...
    return (
        <div className="m-y-3 min-width-450p">
            ...
            <div  className="bg6 m-y-3 padding-20px fc11">
                ...
                <ul className="m-xy-2">
                    <li><span className="fw-bold">jerom@gmail.com</span> (gebruiker, incl honden en lidmaatschappen)</li>
                    <li><span className="fw-bold">josefien@gmail.com</span> (gebruiker, incl honden en lidmaatschappen)</li>
                    <li><span className="fw-bold">bart.stevens9@gmail.com</span> (beheerder, incl honden en lidmaatschappen)</li>
                    <li><span className="fw-bold">superadmin@outlook.com</span> (superbeheerder)</li>
                </ul>
